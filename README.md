...
└───────────┬─────────────────────────────┬───────────────────────┘
            ...
            ▼                             ▼
┌───────────────────┐          ┌─────────────────────┐
│  Simulation Site  │          │  Dashboard           │
│  React + Vite     │          │  Streamlit :8501     │
│  :3000            │          │                      │
│                   │          │  · Face Login        │
│  · 상품 탐색      │          │  · 모델 성능 진단    │
│  · 장바구니       │          │  · 고위험 고객 목록  │
...
│  · face_user   │    │  /.pt/.joblib        │
│  · ops_log     │    │                     │
│  · retention   │    │  data/processed/     │
│  · session 등  │    │  evaluation/         │
│  (15테이블)    │    │  *.json (차트 원천)  │
└────────────────┘    └─────────────────────┘
```
...
> 스크린샷은 `assets/`(또는 `dashboard_streamlit/assets/`)에 추가하세요.
